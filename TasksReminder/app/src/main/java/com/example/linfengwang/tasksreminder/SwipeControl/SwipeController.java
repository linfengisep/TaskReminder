package com.example.linfengwang.tasksreminder.SwipeControl;
...
public class SwipeController extends ItemTouchHelper.Callback {
    ...
    private void drawButtons(Canvas c, RecyclerView.ViewHolder viewHolder) {
        ...
        drawText(itemView.getContext().getResources().getString(R.string.task_finish), c, leftButton, p);

        RectF rightButton = new RectF(itemView.getRight() - buttonWidthWithoutPadding, itemView.getTop(), itemView.getRight(), itemView.getBottom());
        p.setColor(Color.RED);
        c.drawRoundRect(rightButton, corners, corners, p);
        drawText(itemView.getContext().getResources().getString(R.string.task_to_inbox), c, rightButton, p);
